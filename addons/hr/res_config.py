...
class hr_config_settings(osv.osv_memory):
    ...
    _columns = {
        ...
        'group_multi_departments': fields.boolean("Manage Multiple Departments",
            implied_group='hr.group_multi_departments',
            help="""Allows you to manage multiple departments."""),
    }
