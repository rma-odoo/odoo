        ...
        */
        ...
        insert_message: function (message, dom_insert_after, prepend) {
            ...
            if (dom_insert_after && dom_insert_after.parent()[0] == self.$el[0]) {
                ...
                message.prependTo((self.options.view_mailbox && this.thread_level == 0) ? self.$el.parent() : self.$el);
            } else {
                //in wall thread must be add to parent thread
                message.appendTo((self.options.view_mailbox && this.thread_level == 0) ? self.$el.parent() : self.$el);
            }
