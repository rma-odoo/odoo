openerp.mail = function (session) {
    ...
    mail.Thread = session.web.Widget.extend({
        ...
        */
         ...
         */
        render_thread: function(messages, prepend){
            var self = this;
            if (prepend) {
        ...
        */
         ...
         */
        create_thread: function(records, prepend) {
            var self=this;
            ...
            self.render_thread(msg, prepend);
            ...
            _(group_records).each(function(child_msg, parent){
                _(msg).each(function(message){
                    if (message.id == parent) {
                       ...
                       message.thread.render_thread(messages, prepend);
                    }
                });
            });
