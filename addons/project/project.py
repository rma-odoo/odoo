...
class project(osv.osv):
    ...
    def _get_project_task_data(self, cr, uid, ids, field_name, arg, context=None):
        ...
        res = {}
        for id in ids:
            created_domain = [('project_id', '=', id), ('create_date', '>=', date_begin ), ('create_date', '<=', date_end )]
    ...
    _columns = {
        ...
        'task_spark': fields.function(_get_project_task_data, type='char', readonly=True,
...
class task(osv.osv):
    ...
    _columns = {
        ...
        'use_timesheets': fields.related('project_id', 'use_timesheets' , type='boolean', relation='account.analytic.account',string='Timesheets')
    }
    _defaults = {
